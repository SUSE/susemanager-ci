def run(params) {
    ...
    timestamps {
        ...
        stage("Upload local mirror data to AWS mirror") {
            ...
            sh "ssh -o StrictHostKeyChecking=no ${user}@${mirror_hostname_local} 'cd /srv/mirror/; tar -czvf mirror.tar.gz ./'"
            sh "ssh -o StrictHostKeyChecking=no ${user}@${mirror_hostname_local} 'scp -o StrictHostKeyChecking=no -i /root/testing-suma.pem /srv/mirror/mirror.tar.gz ec2-user@${mirror_hostname_aws_public}:/home/ec2-user/' "
