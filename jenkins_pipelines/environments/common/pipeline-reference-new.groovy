def run(params) {
    timestamps {
        ...
        try {
            ...
            stage('Core - Reposync') {
                sh "./terracumber-cli ${common_params} --logfile ${resultdirbuild}/testsuite.log --runstep cucumber --cucumber-cmd 'cd /root/spacewalk/testsuite; rake cucumber:reposync-reference'"
            }
