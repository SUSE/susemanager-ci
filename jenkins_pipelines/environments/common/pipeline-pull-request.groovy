            ...
            stage('Build product') {
                ...
                if(params.must_build) {
                    dir("product") {
                        ...
                        sh "python3 susemanager-utils/testing/automation/obs-project.py --prproject ${params.builder_project} --configfile $HOME/.oscrc --repo ${params.build_repo} add ${params.pull_request_number}"
                        ...
                        sh "bash susemanager-utils/testing/automation/wait-for-builds.sh -a ${params.builder_api} -c $HOME/.oscrc -p ${params.builder_project}:${params.pull_request_number} -r -u"
                        built = true
                    }
                }
            }
