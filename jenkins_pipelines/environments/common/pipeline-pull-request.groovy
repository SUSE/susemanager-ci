def run(params) {
    timestamps {
        ...
        cucumber_idle_timeout = (params.cucumber_idle_timeout ?: 60).toString().toInteger()
            ...
            stage('Checkout CI tools') {
                ws(environment_workspace){
                    if(must_test) {
                        ...
                        env.tf_file = "susemanager-ci/terracumber_config/tf_files/templates/PR-testing.tf"
