    ...
    timestamps {
        ...
        try {
            ...
            stage('Core - Setup') {
                ...
                sh "./terracumber-cli ${common_params} --logfile ${resultdirbuild}/testsuite.log --runstep cucumber --cucumber-cmd 'export LONG_TESTS_ENABLED=${params.run_long_tests}; cd /root/spacewalk/testsuite; rake cucumber:reposync'"
            }
            ...
            stage('Secondary features') {
                def statusCode1 = sh script:"./terracumber-cli ${common_params} --logfile ${resultdirbuild}/testsuite.log --runstep cucumber --cucumber-cmd 'export LONG_TESTS_ENABLED=${params.run_long_tests}; cd /root/spacewalk/testsuite; rake cucumber:secondary'", returnStatus:true
