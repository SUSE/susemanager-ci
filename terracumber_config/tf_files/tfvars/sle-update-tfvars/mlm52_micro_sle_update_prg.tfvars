ENVIRONMENT_CONFIGURATION = {
  ...
  name_prefix     = "mlm-su-52-micro-"
  url_prefix      = "https://ci.suse.de/view/Manager/view/Manager-5.2/job/manager-5.2-qe-mi-validation-mgrtools"
}
BASE_CONFIGURATIONS = {
  base_core = {
    pool                = "ssd"
    ...
    images              = ["sles15sp7o", "opensuse160o", "slmicro62o"]
  }
}
