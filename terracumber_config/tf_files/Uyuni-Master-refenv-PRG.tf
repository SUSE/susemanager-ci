...
variable "URL_PREFIX" {
  type = string
  default = "https://ci.suse.de/view/Manager/view/Uyuni/job/uyuni-master-infra-reference-PRG"
}
...
variable "MAIL_SUBJECT" {
  type = string
  default = "Results Uyuni RefMaster-PRG $status: $tests scenarios ($failures failed, $errors errors, $skipped skipped, $passed passed)"
}
...
variable "MAIL_SUBJECT_ENV_FAIL" {
  type = string
  default = "Results Uyuni RefMaster-PRG: Environment setup failed"
}
