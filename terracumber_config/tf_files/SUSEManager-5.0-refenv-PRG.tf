...
variable "URL_PREFIX" {
  type = string
  default = "https://ci.suse.de/view/Manager/view/Manager-5.0/job/manager-5.0-infra-reference-PRG"
}
...
variable "MAIL_SUBJECT" {
  type = string
  default = "Results REF5.0-PRG $status: $tests scenarios ($failures failed, $errors errors, $skipped skipped, $passed passed)"
}
...
variable "MAIL_SUBJECT_ENV_FAIL" {
  type = string
  default = "Results REF5.0-PRG: Environment setup failed"
}
