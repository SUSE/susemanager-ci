...
variable "URL_PREFIX" {
  type = string
  default = "https://ci.suse.de/view/Manager/view/Manager-5.1/job/manager-5.1-infra-reference-NUE"
}
...
variable "MAIL_SUBJECT" {
  type = string
  default = "Results REF5.1-NUE $status: $tests scenarios ($failures failed, $errors errors, $skipped skipped, $passed passed)"
}
