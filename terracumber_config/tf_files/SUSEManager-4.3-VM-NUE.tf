...
variable "URL_PREFIX" {
  type = string
  default = "https://ci.suse.de/view/Manager/view/Manager-4.3/job/manager-4.3-vm-dev-acceptance-tests-NUE"
}
...
module "cucumber_testsuite" {
  ...
  product_version = "4.3-VM-nightly"
  ...
  images = ["centos7o", "opensuse155o", "sles15sp4o", "ubuntu2204o", "suma43VM-ign"]

  use_avahi    = false
  name_prefix  = "suma-43-newvm-"
  domain       = "mgr.suse.de"
