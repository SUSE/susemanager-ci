...
module "cucumber_testsuite" {
  ...
  host_settings = {
    ...
    server = {
      additional_repos = { cobbler = "http://download.suse.de/ibs/SUSE:/Maintenance:/22864/SUSE_Updates_SLE-Module-SUSE-Manager-Server_4.1_x86_64" }
      provider_settings = {
