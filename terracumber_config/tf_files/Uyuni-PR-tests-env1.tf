...
module "cucumber_testsuite" {
  ...
  images = ["rocky8o", "opensuse154o", "opensuse155-ci-pro", "ubuntu2204o", "sles15sp4o"]
      ...
      additional_grains = {
        hvm_disk_image = {
          leap = {
            ...
            image = "http://minima-mirror-ci-bv.mgr.prv.suse.net/distribution/leap/15.4/appliances/openSUSE-Leap-15.5-JeOS.x86_64-OpenStack-Cloud.qcow2"
            hash = "http://minima-mirror-ci-bv.mgr.prv.suse.net/distribution/leap/15.4/appliances/openSUSE-Leap-15.5-JeOS.x86_64-OpenStack-Cloud.qcow2.sha256"
          }
          sles = {
            hostname = "suma-pr1-min-nested"
