...
variable "URL_PREFIX" {
  type = string
  default = "https://ci.suse.de/view/Manager/view/Manager-5.1/job/manager-5.1-qe-sle-update-NUE"
}
...
module "proxy_containerized" {
  ...
  image              = "slmicro61o"
  provider_settings  = {
    mac                = "aa:b2:93:01:02:7a"
    memory             = 4096
  }
  server_configuration = {
    hostname = "mlm-su-51-server.mgr.suse.de"
    username = "admin"
    password = "admin"
  }
