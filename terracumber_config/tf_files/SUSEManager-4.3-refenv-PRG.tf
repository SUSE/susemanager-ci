...
variable "URL_PREFIX" {
  type = string
  default = "https://ci.suse.de/view/Manager/view/Manager-Head/job/manager-43-infra-reference-PRG"
}
...
variable "MAIL_SUBJECT" {
  type = string
  default = "Results Ref43-PRG $status: $tests scenarios ($failures failed, $errors errors, $skipped skipped, $passed passed)"
}
...
variable "MAIL_SUBJECT_ENV_FAIL" {
  type = string
  default = "Results Ref43-PRG: Environment setup failed"
}
