      ...
      additional_grains = {
        hvm_disk_image = {
          leap = {
            ...
            image = "http://minima-mirror-ci-bv.mgr.suse.de/distribution/leap/15.5/appliances/openSUSE-Leap-15.5-Minimal-VM.x86_64-OpenStack-Cloud.qcow2"
            hash = "http://minima-mirror-ci-bv.mgr.suse.de/distribution/leap/15.5/appliances/openSUSE-Leap-15.5-Minimal-VM.x86_64-OpenStack-Cloud.qcow2.sha256"
          }
          sles = {
            hostname = "uyuni-master-min-nested"
