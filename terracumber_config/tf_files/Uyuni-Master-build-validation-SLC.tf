...
provider "libvirt" {
  uri = "qemu+tcp://giediprime.mgr.slc1.suse.org/system"
}

provider "libvirt" {
  alias = "cosmopolitan"
  uri = "qemu+tcp://cosmopolitan.mgr.slc1.suse.org/system"
}

provider "libvirt" {
  alias = "ginfizz"
  uri = "qemu+tcp://ginfizz.mgr.slc1.suse.org/system"
}

provider "libvirt" {
  alias = "margarita"
  uri = "qemu+tcp://margarita.mgr.slc1.suse.org/system"
}

provider "libvirt" {
  alias = "caipirinha"
  uri = "qemu+tcp://caipirinha.mgr.slc1.suse.org/system"
}
...
module "base_core" {
  ...
  images            = [ "sles15sp4o", "opensuse160o" ]
...
module "base_res" {
  ...
  use_avahi         = false
  domain            = "mgr.slc1.suse.org"
  images            = [ "almalinux8o", "almalinux9o", "almalinux10o", "amazonlinux2023o", "centos7o", "openeuler2403o", "libertylinux9o", "libertylinux10o", "oraclelinux9o", "oraclelinux10o", "rocky8o", "rocky9o", "rocky10o" ]
...
module "base_new_sle" {
  ...
  use_avahi         = false
  domain            = "mgr.slc1.suse.org"
  images            = [ "sles15sp4o", "sles15sp5o", "sles15sp6o", "sles15sp7o", "slemicro53-ign", "slemicro54-ign", "slemicro55o", "slmicro60o", "slmicro61o", "slmicro62o", "tumbleweedo" ]
...
module "opensuse160arm_minion" {
  ...
  provider_settings = {
    ...
    overwrite_fqdn     = "uyuni-bv-master-opensuse160arm-minion.mgr.slc1.suse.org"
    memory             = 2048
    vcpu               = 2
...
module "salt_migration_minion" {
  ...
  server_configuration = {
    hostname = "uyuni-bv-master-proxy.mgr.slc1.suse.org"
  }
...
module "opensuse160arm_sshminion" {
  ...
  provider_settings = {
    ...
    overwrite_fqdn     = "uyuni-bv-master-opensuse160arm-sshminion.mgr.slc1.suse.org"
    memory             = 2048
    vcpu               = 2
    xslt               = file("../../susemanager-ci/terracumber_config/tf_files/common/tune-aarch64.xslt")
  }
...
module "dhcp_dns" {
  ...
  hypervisor = {
    host        = "margarita.mgr.slc1.suse.org"
    user        = "root"
