...
variable "URL_PREFIX" {
  type = string
  default = "https://ci.suse.de/view/Manager/view/Uyuni/job/uyuni-master-dev-acceptance-tests-SLC"
}
...
variable "MAIL_SUBJECT" {
  type = string
  default = "Results Uyuni-Master SLC $status: $tests scenarios ($failures failed, $errors errors, $skipped skipped, $passed passed)"
}
...
variable "MAIL_SUBJECT_ENV_FAIL" {
  type = string
  default = "Results Uyuni-Master SLC: Environment setup failed"
}
...
provider "libvirt" {
  uri = "qemu+tcp://melkor.mgr.slc1.suse.org/system"
}
