...
variable "URL_PREFIX" {
  type = string
  default = "https://ci.suse.de/view/Manager/view/salt/job/manager-salt-shaker-products-testing-sles15sp2"
}
...
variable "MAIL_SUBJECT" {
  type = string
  default = "Results Salt Shaker - products:testing - SLES15SP2 $status: $tests scenarios ($failures failed, $errors errors, $skipped skipped, $passed passed)"
}
...
variable "MAIL_SUBJECT_ENV_FAIL" {
  type = string
  default = "Results Salt Shaker - products:testing - SLES15SP2: Environment setup failed"
}
