...
variable "MAIL_SUBJECT" {
  type = string
  default = "Results Salt Shaker - products:testing - SLE15SP1 $status: $tests scenarios ($failures failed, $errors errors, $skipped skipped, $passed passed)"
}
...
variable "MAIL_SUBJECT_ENV_FAIL" {
  type = string
  default = "Results Salt Shaker - products:testing - SLE15SP1: Environment setup failed"
}
