...
variable "URL_PREFIX" {
  type = string
  default = "https://ci.suse.de/user/manager/my-views/view/Salt%20Shaker/job/manager-salt-shaker-products-testing-slmicro62-bundle"
}
...
variable "MAIL_SUBJECT" {
  type = string
  default = "Results Salt Shaker - products:testing - SLMicro6.2 Salt Bundle $status: $tests scenarios ($failures failed, $errors errors, $skipped skipped, $passed passed)"
}
...
module "salt-shaker-products-testing" {
  ...
  name               = "salt-shaker-products-testing-slmicro62-bundle"
  image              = "slmicro62o"
